...
const Skills = () => {
  return (
    <Element name="skills">
      <div className='min-h-[88vh] w-full bg-[#D7D7D7] md:px-[80px] py-10'>
        <div className="flex flex-col justify-center items-center gap-8 w-full h-full">
          ...
          <div className="flex flex-col justify-start md:w-[40%] w-[60%] gap-10">
            <div className="w-full flex flex-col items-center md:items-start gap-5">
              <h1 className='font-bold font-urbanist text-[25px] text-[#000000] leading-normal tracking-wide'>USING NOW:</h1>
            ...
            <div className="w-full flex flex-col items-center md:items-start gap-5">
              <h1 className='font-bold font-urbanist text-[25px] text-[#000000] leading-normal tracking-wide'>LEARNING:</h1>
              <div className='flex flex-wrap justify-center items-center w-full gap-10'>
                <div className="flex flex-col justify-center items-center gap-2">
                  <NodeLogo />
            ...
            <div className="w-full flex flex-col items-center md:items-start gap-5">
              <h1 className='font-bold font-urbanist text-[25px] text-[#000000] leading-normal tracking-wide'>OTHER SKILLS:</h1>
              <div className='flex flex-wrap justify-center items-center w-full gap-10'>
                <div className="flex flex-col justify-center items-center gap-2">
                  <EnglandFlag />
